...
const SearchBoxFilter: React.FC<SearchWidgetProps> = ({ setSearchQuery }) => {
  return (
    <div className="w-full xl:px-[110px] px-[24px] py-[32px] ">
      <div className="w-full max-w-[1750px] justify-between flex-wrap items-center  flex mx-auto gap-[30px]">
        <SearchBar
          style=""
          bg="bg-[#f0f0f0]"
